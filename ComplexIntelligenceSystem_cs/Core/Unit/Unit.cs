...
[DataContract]
internal class ReadUnit : BaseUnit
{
    [DataMember] public string TypeName { get; set; } = "read unit type";
    ...
    public ReadUnit()
    {
        FeedbackSign.Uid = Content.SetGuid();
    }
...
internal class WriteUnit : BaseUnit
{
    [DataMember] public string TypeName { get; set; } = "write unit type";
...
[DataContract]
internal class ReceiverUnit : BaseUnit
{
    [DataMember] public string TypeName { get; set; } = "receiver unit type";
...
[DataContract]
internal class SenderUnit : BaseUnit
{
    [DataMember] public string TypeName { get; set; } = "sender unit type";
...
[DataContract]
internal class ConnectUnit : BaseUnit
{
    [DataMember] public string TypeName { get; set; } = "connect unit type";
    ...
    [DataMember] public Tuple<float, float> IndexPos { get; set; } = Tuple.Create(0f, 0f);
...
[DataContract]
internal class CanvasUnit : BaseUnit
{
    [DataMember] public string TypeName { get; set; } = "canvas unit type";
